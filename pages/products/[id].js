...
export default function EditProduct() {
  ...
  const fetchData = async () => {
    try {
      ...
      show.error('Failed to load product');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      show.error(error.message || 'Failed to update product');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6 md:py-8">
      <div className="w-full max-w-2xl mx-auto px-3 sm:px-4 md:px-6">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base mt-1">Update product information</p>
        </div>
